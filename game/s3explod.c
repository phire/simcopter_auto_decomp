...
// Type: struct _EXPLODE_DATA[20];

// Type: struct _SMOKE_DATA[100];

// Type: struct Point3d[14];

// Type: struct VRBmpHdr*[9];
...
long S_num_expls = { /* <data@0x005b7380> */ };

// GLOBAL: COPTER_D 0x005b7384
long S_num_smoke = { /* <data@0x005b7384> */ };
