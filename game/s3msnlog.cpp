...
public:
	void list<tagLogBase *>::iterator();
protected:
	void list<tagLogBase *>::iterator(struct list<tagLogBase *>::list_node*);
public:
	int32_t operator==(const class list<tagLogBase *>::iterator&);
	struct tagLogBase*& operator*();
	class list<tagLogBase *>::iterator list<tagLogBase *>::iterator(int32_t);
	class list<tagLogBase *>::iterator& list<tagLogBase *>::iterator();
	class list<tagLogBase *>::iterator list<tagLogBase *>::iterator(int32_t);
	class list<tagLogBase *>::iterator& list<tagLogBase *>::iterator();
};
...
protected:
	...
	protected:
		struct list<tagLogBase *>::list_node* node;
	public:
		void list<tagLogBase *>::const_iterator(const class list<tagLogBase *>::iterator&);
		void list<tagLogBase *>::const_iterator();
	protected:
		void list<tagLogBase *>::const_iterator(struct list<tagLogBase *>::list_node*);
	public:
		int32_t operator==(const class list<tagLogBase *>::const_iterator&);
		const struct tagLogBase*& operator*();
		class list<tagLogBase *>::const_iterator list<tagLogBase *>::const_iterator(int32_t);
		class list<tagLogBase *>::const_iterator& list<tagLogBase *>::const_iterator();
		class list<tagLogBase *>::const_iterator list<tagLogBase *>::const_iterator(int32_t);
		class list<tagLogBase *>::const_iterator& list<tagLogBase *>::const_iterator();
	};
...
public:
	...
	class list<tagLogBase *>::const_iterator list<tagLogBase *>();
	class list<tagLogBase *>::iterator list<tagLogBase *>();
	class list<tagLogBase *>::const_iterator list<tagLogBase *>();
	class list<tagLogBase *>::iterator list<tagLogBase *>();
	class reverse_bidirectional_iterator<list<tagLogBase *>::const_iterator,tagLogBase *,tagLogBase * const &,int> list<tagLogBase *>();
	class reverse_bidirectional_iterator<list<tagLogBase *>::iterator,tagLogBase *,tagLogBase * &,int> list<tagLogBase *>();
	class reverse_bidirectional_iterator<list<tagLogBase *>::const_iterator,tagLogBase *,tagLogBase * const &,int> list<tagLogBase *>();
	class reverse_bidirectional_iterator<list<tagLogBase *>::iterator,tagLogBase *,tagLogBase * &,int> list<tagLogBase *>();
	int32_t empty();
	uint32_t size();
	uint32_t max_size();
	const struct tagLogBase*& list<tagLogBase *>();
	struct tagLogBase*& list<tagLogBase *>();
	const struct tagLogBase*& list<tagLogBase *>();
	struct tagLogBase*& list<tagLogBase *>();
	void swap(class list<tagLogBase *>&);
	void list<tagLogBase *>(class list<tagLogBase *>::iterator, uint32_t, const struct tagLogBase*&);
	void list<tagLogBase *>(class list<tagLogBase *>::iterator, class list<tagLogBase *>::const_iterator, class list<tagLogBase *>::const_iterator);
	void list<tagLogBase *>(class list<tagLogBase *>::iterator, const struct tagLogBase**, const struct tagLogBase**);
	class list<tagLogBase *>::iterator list<tagLogBase *>(class list<tagLogBase *>::iterator, const struct tagLogBase*&);
	void push_front(const struct tagLogBase*&);
	void push_back(const struct tagLogBase*&);
	void list<tagLogBase *>(class list<tagLogBase *>::iterator, class list<tagLogBase *>::iterator);
	void list<tagLogBase *>(class list<tagLogBase *>::iterator);
	void pop_front();
	void pop_back();
	void ~list<tagLogBase *>();
...
public:
	void list<tagLogBase *>(class list<tagLogBase *>::iterator, class list<tagLogBase *>&, class list<tagLogBase *>::iterator, class list<tagLogBase *>::iterator);
	void list<tagLogBase *>(class list<tagLogBase *>::iterator, class list<tagLogBase *>&, class list<tagLogBase *>::iterator);
	void list<tagLogBase *>(class list<tagLogBase *>::iterator, class list<tagLogBase *>&);
...
// LINE 54:
	...
	__asm        je     near ptr 0x004EC0E3;
// LINE 55:
	__asm        mov    ecx, this;
	__asm        call   0x004ED729;
// LINE 56:
	__asm        mov    eax, this;
	__asm        mov    eax, [eax];
	__asm        mov    [ebp-8], eax;
...
// LINE 106:
	...
	__asm        jge    near ptr 0x004EC229;
// LINE 107:
	__asm        jmp    near ptr 0x004EC1F4;
// LINE 108:
	__asm        cmp    lPresentRecordDataLength, 0x38;
	__asm        jle    near ptr 0x004EC238;
// LINE 109:
	__asm        jmp    near ptr 0x004EC1F4;
// LINE 110:
	__asm        push   0xC;
...
// LINE 111:
	...
	__asm        push   eax;
	__asm        mov    ecx, this;
	__asm        call   0x004EC70D;
	__asm        test   eax, eax;
	__asm        jne    near ptr 0x004EC262;
// LINE 112:
	__asm        jmp    near ptr 0x004EC1F4;
// LINE 113:
	__asm        mov    eax, miffReader;
...
// LINE 220:
	...
	__asm        jb     near ptr 0x004EC782;
// LINE 221:
	__asm        push   0x64;
	__asm        mov    ecx, this;
	__asm        call   0x004ED947;
// LINE 223:
	__asm        cmp    bSetTime, 0;
	__asm        je     near ptr 0x004EC7A7;
// LINE 224:
	...
	__asm        mov    [ecx+4], eax;
	__asm        jmp    near ptr 0x004EC7A7;
// LINE 225:
	__asm        mov    eax, logData;
	__asm        cmp    dword ptr [eax], 1;
	__asm        jne    near ptr 0x004EC8C2;
// LINE 227:
// Block start:
