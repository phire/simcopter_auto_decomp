...
// Type: struct _fPoint2d[11][4][4];

// Type: struct Point3d[3][10][4][4];

// Type: int32_t[4][4][3][10][4][4];

// Type: int32_t[4][4][4];

// Type: struct Point3d[4];

// Type: struct Point3d[4][4];
...
const struct _dPoint2d OT[4] = { /* <data@0x00593338> */ };

// GLOBAL: COPTER_D 0x00593378
const struct _dPoint2d RRT[4] = { /* <data@0x00593378> */ };

// GLOBAL: COPTER_D 0x005933b8
const struct _dPoint2d LRT[4] = { /* <data@0x005933b8> */ };
