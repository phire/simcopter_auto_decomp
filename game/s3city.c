...
_T38:
	...
	__asm        jne    _Tad;
// LINE 220:
	_assert(0x5b5a18, 0x5b59f8, 0xdc);
	__asm        jmp    _T72;

	__asm        jmp    _T72;
// LINE 221:
_T72:
	GetPathForFile(0x4, 0x0, 0x5b5a1c, szFilePath[0]);
// LINE 222:
...
// LINE 300:
	...
	__asm        add    esp, 4;
// LINE 307:
	MTArbRotMat(0x62a458, 0xc4e0000, 0x59b508);
// LINE 308:
	MTArbRotMat(0x609c00, 0x1c20000, 0x59b508);
// LINE 312:
...
// LINE 315:
	...
	__asm        je     _T3dd;
// LINE 316:
	strncpy(tempLogCityEnterExit.szCity[0], CityNameString, 0x20);
// LINE 317:
	__asm        jmp    _T3e8;
// LINE 318:
_T3dd:
...
// LINE 319:
_T3e8:
	S3AddLogEntry(tempLogCityEnterExit.nType, 0x0);
// LINE 321:
	return 0x0;
// LINE 322:
}
	...
	for (x = 0x0; (x < 0x80); x++) {
		...
		_FOR_3f:
			for (y = 0x0; (y < 0x80); y++) {
				...
				// LINE 1123:
					sptr = S2Alloc(G_citymempool, 0x10);
				// LINE 1124:
					__asm        mov    eax, cptr;
					__asm        mov    ecx, x;
					__asm        dec    ecx;
				...
				// LINE 1225:
					...
					__asm        mov    obj, eax;
				// LINE 1226:
					obj2 = S3CityGetBase(x, y, reinterpret_cast<int16_t>(size));
				// LINE 1227:
					__asm        jmp    _T3814;
				// LINE 1229:
				_T185b:
				...
				// LINE 1646:
					objcount = 0x1;
				// LINE 1647:
					obj = S3CityGetBase(x, y, reinterpret_cast<int16_t>(size));
				// LINE 1648:
				...
				// LINE 2100:
					...
					__asm        jne    _T3e3d;
				// LINE 2102:
					sptr->next = S2Alloc(G_citymempool, 0x10);
				// LINE 2103:
					sptr = sptr->next;
				// LINE 2104:
					sptr->next = 0x0;
...
// LINE 2468:
	S3CitySpiralScan(S_curr_pos.x, S_curr_pos.y, spiral_dist);
// LINE 2469:
	return;
// LINE 2473:
_Tb2:
...
// LINE 2724:
_T229:
	S3CityGetCells((0x6c1210 + 0x2c), 0x609108, 0x62a4a0, 0x609bf0, 0x62a498);
// LINE 2725:
	S3CityGetCells((0x6c1210 + 0x44), 0x629c50, 0x609104, 0x62a4c8, 0x62a498);
// LINE 2733:
	__asm        mov    eax, ViewState.world_pos.x;
		...
		_FOR_c9:
			for (x = lcell->x; (x_pos > x); x++) {
				...
				// LINE 3267:
					...
					__asm        jle    _T1be;
				// LINE 3269:
					city_subscan_horiz(x, 0x1, y_dir, lcell, lend, fovcell);
				// LINE 3271:
					__asm        jmp    _T1c4;
				// LINE 3273:
				_T1be:
		...
		_FOR_25f:
			for (x = rcell->x; (x_pos < x); x--) {
				...
				// LINE 3310:
					...
					__asm        jge    _T354;
				// LINE 3312:
					city_subscan_horiz(x, -0x1, y_dir, rcell, rend, fovcell);
				// LINE 3314:
					__asm        jmp    _T35a;
				// LINE 3316:
				_T354:
		...
		_FOR_c8:
			for (y = tcell->y; (y < y_pos); y++) {
				...
				// LINE 3417:
					...
					__asm        jge    _T1be;
				// LINE 3419:
					city_subscan_vert(y, x_dir, 0x1, tcell, tend, fovcell);
				// LINE 3421:
					__asm        jmp    _T1c4;
				// LINE 3423:
				_T1be:
		...
		_FOR_260:
			for (y = bcell->y; (y > y_pos); y--) {
				...
				// LINE 3457:
					...
					__asm        jle    _T356;
				// LINE 3459:
					city_subscan_vert(y, x_dir, -0x1, bcell, bend, fovcell);
				// LINE 3461:
					__asm        jmp    _T35c;
				// LINE 3463:
				_T356:
...
_FOR_aa:
	for (x = edge->x; (x <= cellpos); x++) {
		...
		// LINE 3556:
			...
			__asm        jne    _T1c0;
		// LINE 3558:
			city_subscan_horiz(x, x_dir, y_dir, edge, endedge, fovcell);
		// LINE 3560:
			fovcell->x = reinterpret_cast<int16_t>(reinterpret_cast<uint16_t>(x));
		// LINE 3561:
			fovcell->y = reinterpret_cast<int16_t>(reinterpret_cast<uint16_t>(y));
...
// LINE 3619:
	...
	__asm        jne    _T41c;
// LINE 3621:
	city_subscan_horiz(cellpos, x_dir, y_dir, edge, endedge, fovcell);
// LINE 3624:
_T41c:
...
_FOR_89:
	for (y = edge->y; (y <= cellpos); y++) {
		...
		// LINE 3663:
			...
			__asm        jne    _T19f;
		// LINE 3665:
			city_subscan_vert(y, x_dir, y_dir, edge, endedge, fovcell);
		// LINE 3667:
			fovcell->x = reinterpret_cast<int16_t>(reinterpret_cast<uint16_t>(x));
		// LINE 3668:
			fovcell->y = reinterpret_cast<int16_t>(reinterpret_cast<uint16_t>(y));
...
// LINE 3727:
	...
	__asm        jne    _T3fe;
// LINE 3729:
	city_subscan_vert(cellpos, x_dir, y_dir, edge, endedge, fovcell);
// LINE 3732:
_T3fe:
	curr_fovcell-> = fovcell;
// LINE 3735:
...
_FOR_55:
	for (; (S_fovlast >= cellptr); cellptr += 0x8) {
		...
		// LINE 3805:
			...
			__asm        jne    _T18a;
		// LINE 3807:
			texid = VRInt2BmpHdr(G_restex, texid);
		// LINE 3808:
			deltac = 0x0;
		// LINE 3810:
			__asm        jmp    _T1a0;
