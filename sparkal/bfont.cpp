...
public:
	const class MRect* vector<MRect>();
	class MRect* vector<MRect>();
	const class MRect* vector<MRect>();
	class MRect* vector<MRect>();
	class reverse_iterator<MRect const *,MRect,MRect const &,int> vector<MRect>();
	class reverse_iterator<MRect *,MRect,MRect &,int> vector<MRect>();
	class reverse_iterator<MRect const *,MRect,MRect const &,int> vector<MRect>();
	class reverse_iterator<MRect *,MRect,MRect &,int> vector<MRect>();
	uint32_t size();
	uint32_t max_size();
	uint32_t capacity();
	int32_t empty();
	const class MRect& vector<MRect>(uint32_t);
	class MRect& vector<MRect>(uint32_t);
	...
	void vector<MRect>(class MRect*, uint32_t, const class MRect&);
	void vector<MRect>(class MRect*, const class MRect*, const class MRect*);
	class MRect* vector<MRect>(class MRect*, const class MRect&);
	void pop_back();
	void vector<MRect>(class MRect*, class MRect*);
	void vector<MRect>(class MRect*);
};
...
public:
	...
	unsigned char * vector<unsigned char>();
	unsigned char * vector<unsigned char>();
	class reverse_iterator<unsigned char const *,unsigned char,unsigned char const &,int> vector<unsigned char>();
	class reverse_iterator<unsigned char *,unsigned char,unsigned char &,int> vector<unsigned char>();
	class reverse_iterator<unsigned char const *,unsigned char,unsigned char const &,int> vector<unsigned char>();
	class reverse_iterator<unsigned char *,unsigned char,unsigned char &,int> vector<unsigned char>();
	uint32_t size();
	uint32_t max_size();
	uint32_t capacity();
	int32_t empty();
	const unsigned char& vector<unsigned char>(uint32_t);
	unsigned char& vector<unsigned char>(uint32_t);
	...
	void reserve(uint32_t);
	const unsigned char& vector<unsigned char>();
	unsigned char& vector<unsigned char>();
	const unsigned char& vector<unsigned char>();
	unsigned char& vector<unsigned char>();
	void push_back(const unsigned char&);
	void swap(class vector<unsigned char>&);
	void vector<unsigned char>(unsigned char *, uint32_t, const unsigned char&);
	void vector<unsigned char>(unsigned char *, unsigned char *, unsigned char *);
	unsigned char * vector<unsigned char>(unsigned char *, const unsigned char&);
	void pop_back();
	void vector<unsigned char>(unsigned char *, unsigned char *);
	void vector<unsigned char>(unsigned char *);
};
