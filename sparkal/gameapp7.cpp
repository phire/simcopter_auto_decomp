...
// LINE 677:
	...
	__asm        call   dword ptr [eax+0x40];
// LINE 682:
	__asm        call   0x004EEEB7;
	__asm        push   eax;
	__asm        call   0x004EEF09;
	__asm        add    esp, 4;
	__asm        push   eax;
	__asm        mov    eax, this;
