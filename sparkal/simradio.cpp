...
public:
	...
	int32_t * end();
	int32_t * end();
	class reverse_iterator<int const *,int,int const &,int> rbegin();
	class reverse_iterator<int *,int,int &,int> rbegin();
	class reverse_iterator<int const *,int,int const &,int> rend();
	class reverse_iterator<int *,int,int &,int> rend();
	uint32_t size();
	uint32_t max_size();
	uint32_t capacity();
	int32_t empty();
...
public:
	...
	class RadioStation* begin();
	const class RadioStation* end();
	class RadioStation* end();
	class reverse_iterator<RadioStation const *,RadioStation,RadioStation const &,int> rbegin();
	class reverse_iterator<RadioStation *,RadioStation,RadioStation &,int> rbegin();
	class reverse_iterator<RadioStation const *,RadioStation,RadioStation const &,int> rend();
	class reverse_iterator<RadioStation *,RadioStation,RadioStation &,int> rend();
	uint32_t size();
	uint32_t max_size();
	uint32_t capacity();
	int32_t empty();
	const class RadioStation& operator[](uint32_t);
	class RadioStation& operator[](uint32_t);
	...
	void reserve(uint32_t);
	const class RadioStation& front();
	class RadioStation& front();
	const class RadioStation& back();
	class RadioStation& back();
	void push_back(const class RadioStation&);
	void swap(class vector<RadioStation>&);
	void insert(class RadioStation*, uint32_t, const class RadioStation&);
	void insert(class RadioStation*, const class RadioStation*, const class RadioStation*);
	class RadioStation* insert(class RadioStation*, const class RadioStation&);
	void pop_back();
	void erase(class RadioStation*, class RadioStation*);
	void erase(class RadioStation*);
};
