...
class Keyboard{ // packed(0x110 bytes) TI: 0x4574
public:
	void Keyboard();
...
// Type: /*packed*/ class Keyboard;
class Keyboard{ // packed(0x110 bytes) TI: 0x458d
public:
	void Keyboard();
	int32_t IsKeyDown(unsigned char, unsigned char);
	int32_t IsKeyDown(unsigned char);
...
// Type: /*packed*/ class Keyboard (forward reference);
class Keyboard{ // packed(0x110 bytes) TI: 0x458d
public:
	void Keyboard();
	int32_t IsKeyDown(unsigned char, unsigned char);
...
// LINE 85:
	this->CharList::DeleteItem(chKey);
// LINE 87:
_T3a:
	return;
}
