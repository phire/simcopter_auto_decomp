...
// LINE 1134:
	...
	__asm        add    eax, 0x148;
	__asm        push   eax;
	__asm        call   0x0048C234;
	__asm        add    esp, 4;
	__asm        test   eax, eax;
	__asm        jne    near ptr 0x004C01A3;
// LINE 1135:
	__asm        mov    ecx, this;
	__asm        call   0x004C02FF;
// LINE 1136:
	__asm        mov    ecx, this;
	__asm        add    ecx, 0x70;
