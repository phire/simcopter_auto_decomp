...
"	      0044fc67    push esi"
"	      0044fc68    push edi"
"	      0044fc69    mov this,ecx"
);
// LINE 592:
	asm( 
"	      0044fc6c    mov eax,this"
"	      0044fc6f    mov ecx,this"
...
// LINE 593:
	asm( 
"	      0044fc7d    mov eax,this"
"	      0044fc80    mov eax,[eax]"
"	      0044fc82    mov nTemp,eax"
);
// LINE 594:
	asm( 
"	      0044fc85    mov eax,this"
"	      0044fc88    mov eax,[eax+8]"
"	      0044fc8b    mov ecx,this"
"	      0044fc8e    mov [ecx],eax"
);
// LINE 595:
	asm( 
"	      0044fc90    mov eax,nTemp"
"	      0044fc93    mov ecx,this"
"	      0044fc96    mov [ecx+8],eax"
);
// LINE 597:
	asm( 
"	      0044fc99    mov eax,this"
"	      0044fc9c    mov ecx,this"
...
// LINE 598:
	asm( 
"	      0044fcab    mov eax,this"
"	      0044fcae    mov eax,[eax+4]"
"	      0044fcb1    mov nTemp,eax"
);
// LINE 599:
	asm( 
"	      0044fcb4    mov eax,this"
"	      0044fcb7    mov eax,[eax+0Ch]"
"	      0044fcba    mov ecx,this"
"	      0044fcbd    mov [ecx+4],eax"
);
// LINE 600:
	asm( 
"	      0044fcc0    mov eax,nTemp"
"	      0044fcc3    mov ecx,this"
