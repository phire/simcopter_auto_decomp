...
// LINE 594:
	...
	__asm        fcom;
	__asm        inc    edx;
	__asm        add    [eax+edx*8-0x2EC7FFBE], ch;
	__asm        inc    edx;
	__asm        add    [eax], al;
	__asm        rol    byte ptr [edx], cl;
	__asm        retf   0x42D0;
	__asm        add    [esi+0x60042D1], ah;
	__asm        rol    dword ptr [edx], 1;
	__asm        adc    cl, dl;
	__asm        inc    edx;
	__asm        add    [edx], cl;
	__asm        rol    byte ptr [edx], cl;
	...
	__asm        or     dl, dl;
	__asm        inc    edx;
	__asm        add    [ecx+edx*8-0x2DF5FFBE], bl;
	__asm        inc    edx;
	__asm        add    ah, al;
	__asm        rol    dword ptr [edx], 1;
	__asm        cmp    dword ptr [ebp-0xC], 0xC07;
	__asm        jg     near ptr 0x0042D317;
	__asm        je     near ptr 0x0042D14C;
	__asm        sub    dword ptr [ebp-0xC], 0x809;
	__asm        cmp    dword ptr [ebp-0xC], 0xD;
	__asm        ja     near ptr 0x0042D20A;
	__asm        mov    eax, [ebp-0xC];
	__asm        xor    ecx, ecx;
	__asm        mov    cl, [eax+0x42D309];
	__asm        jmp    dword ptr [ecx*4+0x42D2E9];
	__asm        aam    0xD0;
	__asm        inc    edx;
	__asm        add    [eax+0x1A0042D1], dh;
	__asm        rol    dword ptr [edx], 1;
	__asm        push   0xFFFFFFD1;
	__asm        inc    edx;
	__asm        add    al, al;
	__asm        rol    byte ptr [edx], 1;
	__asm        jle    short 0x0042D2D0;
	__asm        inc    edx;
	__asm        add    [edx+0xA0042D1], dl;
	__asm        rol    byte ptr [edx], cl;
	__asm        add    [ecx], al;
	__asm        pop    es;
	__asm        add    al, [edi];
	...
	__asm        jg     near ptr 0x0042D356;
	__asm        je     near ptr 0x0042D0E8;
	__asm        cmp    dword ptr [ebp-0xC], 0xC09;
	__asm        je     near ptr 0x0042D0DE;
	__asm        cmp    dword ptr [ebp-0xC], 0xC0A;
	__asm        je     near ptr 0x0042D1BA;
	__asm        cmp    dword ptr [ebp-0xC], 0xC0C;
	__asm        je     near ptr 0x0042D124;
	__asm        jmp    near ptr 0x0042D20A;
	__asm        cmp    dword ptr [ebp-0xC], 0x100C;
	__asm        je     near ptr 0x0042D12E;
	__asm        cmp    dword ptr [ebp-0xC], 0x1409;
	__asm        je     near ptr 0x0042D0F2;
