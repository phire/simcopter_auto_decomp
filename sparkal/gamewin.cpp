...
public:
	...
	virtual unsigned long MakePalette(const struct SparkalColor*); // vtable+0x3c
	virtual void UpdatePalette(long, long, struct SparkalColor*) /* override */;
	virtual void ProcessWindowMove(); // vtable+0x40
	virtual void CenterWindow(); // vtable+0x44
	virtual void PlaceWindowRect(class MRect*); // vtable+0x48
