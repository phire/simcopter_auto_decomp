...
public:
	void list<GraphicWindow *>::iterator();
protected:
	void list<GraphicWindow *>::iterator(struct list<GraphicWindow *>::list_node*);
public:
	int32_t operator==(const class list<GraphicWindow *>::iterator&);
	class GraphicWindow*& operator*();
	class list<GraphicWindow *>::iterator list<GraphicWindow *>::iterator(int32_t);
	class list<GraphicWindow *>::iterator& list<GraphicWindow *>::iterator();
	class list<GraphicWindow *>::iterator list<GraphicWindow *>::iterator(int32_t);
	class list<GraphicWindow *>::iterator& list<GraphicWindow *>::iterator();
};
...
protected:
	...
	protected:
		struct list<GraphicWindow *>::list_node* node;
	public:
		void list<GraphicWindow *>::const_iterator(const class list<GraphicWindow *>::iterator&);
		void list<GraphicWindow *>::const_iterator();
	protected:
		void list<GraphicWindow *>::const_iterator(struct list<GraphicWindow *>::list_node*);
	public:
		int32_t operator==(const class list<GraphicWindow *>::const_iterator&);
		const class GraphicWindow*& operator*();
		class list<GraphicWindow *>::const_iterator list<GraphicWindow *>::const_iterator(int32_t);
		class list<GraphicWindow *>::const_iterator& list<GraphicWindow *>::const_iterator();
		class list<GraphicWindow *>::const_iterator list<GraphicWindow *>::const_iterator(int32_t);
		class list<GraphicWindow *>::const_iterator& list<GraphicWindow *>::const_iterator();
	};
...
public:
	...
	class list<GraphicWindow *>::const_iterator list<GraphicWindow *>();
	class list<GraphicWindow *>::iterator list<GraphicWindow *>();
	class list<GraphicWindow *>::const_iterator list<GraphicWindow *>();
	class list<GraphicWindow *>::iterator list<GraphicWindow *>();
	class reverse_bidirectional_iterator<list<GraphicWindow *>::const_iterator,GraphicWindow *,GraphicWindow * const &,int> list<GraphicWindow *>();
	class reverse_bidirectional_iterator<list<GraphicWindow *>::iterator,GraphicWindow *,GraphicWindow * &,int> list<GraphicWindow *>();
	class reverse_bidirectional_iterator<list<GraphicWindow *>::const_iterator,GraphicWindow *,GraphicWindow * const &,int> list<GraphicWindow *>();
	class reverse_bidirectional_iterator<list<GraphicWindow *>::iterator,GraphicWindow *,GraphicWindow * &,int> list<GraphicWindow *>();
	int32_t empty();
	uint32_t size();
	uint32_t max_size();
	const class GraphicWindow*& list<GraphicWindow *>();
	class GraphicWindow*& list<GraphicWindow *>();
	const class GraphicWindow*& list<GraphicWindow *>();
	class GraphicWindow*& list<GraphicWindow *>();
	void swap(class list<GraphicWindow *>&);
	void list<GraphicWindow *>(class list<GraphicWindow *>::iterator, uint32_t, const class GraphicWindow*&);
	void list<GraphicWindow *>(class list<GraphicWindow *>::iterator, class list<GraphicWindow *>::const_iterator, class list<GraphicWindow *>::const_iterator);
	void list<GraphicWindow *>(class list<GraphicWindow *>::iterator, const class GraphicWindow**, const class GraphicWindow**);
	class list<GraphicWindow *>::iterator list<GraphicWindow *>(class list<GraphicWindow *>::iterator, const class GraphicWindow*&);
	void push_front(const class GraphicWindow*&);
	void push_back(const class GraphicWindow*&);
	void list<GraphicWindow *>(class list<GraphicWindow *>::iterator, class list<GraphicWindow *>::iterator);
	void list<GraphicWindow *>(class list<GraphicWindow *>::iterator);
	void pop_front();
	void pop_back();
	void ~list<GraphicWindow *>();
...
public:
	void list<GraphicWindow *>(class list<GraphicWindow *>::iterator, class list<GraphicWindow *>&, class list<GraphicWindow *>::iterator, class list<GraphicWindow *>::iterator);
	void list<GraphicWindow *>(class list<GraphicWindow *>::iterator, class list<GraphicWindow *>&, class list<GraphicWindow *>::iterator);
	void list<GraphicWindow *>(class list<GraphicWindow *>::iterator, class list<GraphicWindow *>&);
