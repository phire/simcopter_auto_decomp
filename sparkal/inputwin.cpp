...
// list<Shortcut>::list_node_buffer Class implementation not found
...
// list<HotSpot>::list_node_buffer Class implementation not found

// Type: struct list<HotSpot>::list_node (forward reference);
// list<HotSpot>::list_node Class implementation not found

// Type: char *;

// Type: struct rb_tree<long,long,ident<long,long>,less<long>>::rb_tree_node_buffer (forward reference);
// rb_tree<long,long,ident<long,long>,less<long>>::rb_tree_node_buffer Class implementation not found

// Type: struct rb_tree<long,long,ident<long,long>,less<long>>::rb_tree_node (forward reference);
// rb_tree<long,long,ident<long,long>,less<long>>::rb_tree_node Class implementation not found
...
// list<StringIDAssociation>::list_node_buffer Class implementation not found

// Type: struct list<StringIDAssociation>::list_node (forward reference);
// list<StringIDAssociation>::list_node Class implementation not found

// Type: struct list<KeyColors>::list_node_buffer (forward reference);
// list<KeyColors>::list_node_buffer Class implementation not found

// Type: struct list<KeyColors>::list_node (forward reference);
// list<KeyColors>::list_node Class implementation not found
